export default function MissionPage() {
    return (
        <div className="py-12 px-5 md:py-24 md:px-12 max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-black text-text-dark mb-6 md:mb-8 animate-slide-right">Our Mission</h1>
            <div className="h-1 w-24 bg-primary mb-8 md:mb-12 rounded-full animate-reveal delay-100"></div>
            <div className="prose prose-lg text-gray-600 space-y-6 md:space-y-8">
                <blockquote className="text-xl md:text-3xl font-medium text-dark-teal italic border-l-4 border-primary pl-6 md:pl-8 my-8 md:my-12 animate-slide-right delay-200">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-text-dark mt-12 md:mt-16 mb-4 md:mb-6 animate-slide-up delay-400">Our Core Values</h2>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 list-none p-0">
                    <li className="bg-bg-gray p-6 md:p-8 rounded-2xl animate-scale-in delay-100">
                    ...
                    <li className="bg-bg-gray p-6 md:p-8 rounded-2xl animate-scale-in delay-200">
                    ...
                    <li className="bg-bg-gray p-6 md:p-8 rounded-2xl animate-scale-in delay-300">
                    ...
                    <li className="bg-bg-gray p-6 md:p-8 rounded-2xl animate-scale-in delay-400">
